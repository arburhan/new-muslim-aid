            ...
            <section className="py-16 md:py-24">
                <div className="container-custom max-w-2xl">
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-10 md:p-14 text-center">
                        <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-8 animate-pulse">
                        ...
                        <div className="inline-block bg-gradient-to-r from-green-50 to-teal-50 rounded-xl px-6 py-3 border border-green-200">
